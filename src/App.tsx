                ...
                <WishlistProvider>
                  ...
                  <BrowserRouter>
                    <Routes>
                      ...
                      <Route path="/seller/products/add" element={<SellerProtectedRoute><SellerAddProduct /></SellerProtectedRoute>} />
                      ...
                      <Route path="/seller/payouts" element={<SellerProtectedRoute><SellerPayouts /></SellerProtectedRoute>} />
                      <Route path="/seller/analytics" element={<SellerProtectedRoute><SellerAnalytics /></SellerProtectedRoute>} />
                      <Route path="/seller/support" element={<SellerProtectedRoute><SellerSupport /></SellerProtectedRoute>} />
